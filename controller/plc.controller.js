    ...
    try {
      ...
      for (let j = 0; j < countyNames.length; j++) {
        ...
        if (items.length > 0) {
          ...
          console.log('🔍 DEBUG - First item sample:', JSON.stringify(items[0], null, 2).substring(0, 500))
        }
      ...
      await this.loggingService.writeMessage('plcProcessWithVisionFatal', err.message)
