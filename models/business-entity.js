...
class BusinssEntity extends Model {
  static init(sequelize) {
    return super.init({
      ...
      sequelize,
      modelName: 'ContactReady',
      tableName: 'contactsready',
      timestamps: true,
      underscored: true,
      ...
      indexes: [
        {
          unique: true,
          fields: ['name', 'first_name', 'last_name', 'llc_owner', 'address', 'city', 'state', 'zip'],
          name: 'contactsready_unique_contact'
        },
        {
          fields: ['name']
        },
